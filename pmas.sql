...
UPDATE `admin` SET `password` = '1234' WHERE `admin`.`ID` = 'admin';
...
('p114', NULL, NULL, 's113', 'f112', 'CSFF-SDM.doc', 'CSFF-SDM.doc', 'hello');
 (`p_id`, `name`, `domain`, `s_id`, `f_id`, `ppf`, `psf`, `remark`) ,
('3301', 'Pratik A', 'ML', '3301', 'F101', '', '', ''), 
('3318', 'Shubham H', 'AI', '3318', 'f112', '', '', '');
...
('', '', '', 'admin', 'admin', '', 'Selcet'),
('1213', 'Pratik A', 'pratika@gmail.com', '9764844439', 'admin', '2020', 'MCA I'),
('1234', 'Ram k', 'ram123@gmail.com', '987456321', '1234', '2021', 'MCA I');
('1062', 'kumar M', 'kumarm1@gmail.com', '987456321', '1234', '2020', 'MCA I')
('3305', 'Ritesh M', 'Rityam@yahoo.com', '9764844439', '1234@', '2019', 'MCA II');
('12345', 'Pritesh', 'p4@yahoo.com', '2324345', 'bunny', '2016', 'CSE'),
('1070', 'saaya', 'saaya@gmail.com', '9764844439', '1234', '2018', 'MBA');
