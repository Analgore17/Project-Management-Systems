...
<table width="100%" border="0" cellspacing="01" cellpadding="01">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
       ...
       <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Student ID&nbsp;:&nbsp;</font></td><br>
    <td><input id="in" type="text" name="sid" value="<?php echo $row['s_id'];?>"/></td><br>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><select name="stream" style="width: 13em; height: 2em; font-size: 15px; ">
         ...
         <option value="MCA" <?php if($row['stream']=='MCA') echo 'selected="selected"'; ?>>MCA</option>
        <option value="MBA" <?php if($row['stream']=='MBA') echo 'selected="selected"'; ?>>MBA</option>
        <option value="MSW" <?php if($row['stream']=='MSW') echo 'selected="selected"'; ?>>MSW</option>          
        </select></td>
    <td>&nbsp;</td>
  </tr>
